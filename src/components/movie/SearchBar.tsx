...
export default function SearchBar() {
  ...
  return ( <form onSubmit={handleSubmit} className="flex w-full max-w-sm items-center space-x-4 p-4 rounded-lg border border-border bg-background px-4 py-2">
        ...
        {isLoading && <span className="animate-spin text-4xl">🌀</span>}
    </form>
  );
}
